...
<Aside type="info">
Checkout the [Tutorials](tutorials) for examples and practical advices on how to setup and use authentication for your API
</Aside>
...
When you use a custom service, you need to [register](kit-introduction#registrations) it, either via decorators or manual registration.
</Aside>
